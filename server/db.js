...
-- Shareable "beat the Computer" challenge links (the growth loop). A player
-- creates one, shares the link; whoever opens it plays the same bot difficulty
-- as a guest. plays/beats tally the social proof ("N tried, M beat it").
