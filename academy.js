...
(function () {
  ...
  const LESSONS = [
    ...
    { id:'BR04', chapter:'Mate in 1', title:'A-File Rook Lift vs King on e8', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR05', chapter:'Mate in 1', title:'B-File Rook Lift vs King on e8', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR06', chapter:'Mate in 1', title:'C-File Rook Lift vs King on e8', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR07', chapter:'Mate in 1', title:'H-File Rook Lift vs King on e8', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR12', chapter:'Mate in 1', title:'Second-Rank Rook Lift vs King on f8', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR14', chapter:'Mate in 1', title:'C-File Lift vs King on f8', desc:'White to play and mate in one with the rook.',
      ...
      solution:[{from:'c2', to:'c8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR15', chapter:'Mate in 1', title:'H-File Rook Lift vs King on f8', desc:'White to play and mate in one with the rook.',
    ...
    { id:'QM04', chapter:'Mate in 1', title:'Queen Mate on h8', desc:'White to play and mate in one with the queen.',
      fen:'7k/5Q2/6K1/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'f7', to:'f8'}, {from:'f7', to:'h7'}, {from:'f7', to:'g7'}, {from:'f7', to:'e8'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    ...
    { id:'QM06', chapter:'Mate in 1', title:'Queen Mate on a8', desc:'White to play and mate in one with the queen.',
      fen:'k7/2Q5/1K6/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'c7', to:'c8'}, {from:'c7', to:'b7'}, {from:'c7', to:'a7'}, {from:'c7', to:'d8'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM07', chapter:'Mate in 1', title:'Queen Mate on a1', desc:'White to play and mate in one with the queen.',
      fen:'8/8/8/8/8/8/K7/k5Q1 w - - 0 1', side:'w',
      solution:[{from:'g1', to:'a1'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM08', chapter:'Mate in 1', title:'Queen Mate on g8', desc:'White to play and mate in one with the queen.',
      fen:'6k1/4Q3/5K2/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'e7', to:'g7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM09', chapter:'Mate in 1', title:'Queen Mate on g1', desc:'White to play and mate in one with the queen.',
      fen:'8/8/8/8/8/8/7K/Q5k1 w - - 0 1', side:'w',
      solution:[{from:'a1', to:'g1'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    ...
    { id:'QM11', chapter:'Mate in 1', title:'Queen Mate on b8', desc:'White to play and mate in one with the queen.',
      fen:'1k6/3Q4/2K5/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'d7', to:'b7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM12', chapter:'Mate in 1', title:'Queen Mate on d1 along the First Rank', desc:'White to play and mate in one with the queen.',
      fen:'8/8/8/8/8/8/3K4/3k2Q1 w - - 0 1', side:'w',
      solution:[{from:'g1', to:'d1'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM13', chapter:'Mate in 1', title:'Queen Mate on h3', desc:'White to play and mate in one with the queen.',
      fen:'8/8/8/8/8/5K1k/8/5Q2 w - - 0 1', side:'w',
      solution:[{from:'f1', to:'h1'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    ...
    { id:'QM15', chapter:'Mate in 1', title:'Queen Mate on c8', desc:'White to play and mate in one with the queen.',
      fen:'2k5/8/2K5/8/8/8/6Q1/8 w - - 0 1', side:'w',
      solution:[{from:'g2', to:'g8'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM16', chapter:'Mate in 1', title:'Queen Mate on g1 along the First Rank', desc:'White to play and mate in one with the queen.',
      fen:'8/8/8/8/8/6K1/8/Q5k1 w - - 0 1', side:'w',
      solution:[{from:'a1', to:'b1'}, {from:'a1', to:'c1'}, {from:'a1', to:'d1'}, {from:'a1', to:'e1'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    ...
    { id:'QM18', chapter:'Mate in 1', title:'Queen Mate on a8 along the a-File', desc:'White to play and mate in one with the queen.',
      fen:'k7/8/1K6/8/8/8/8/Q7 w - - 0 1', side:'w',
      solution:[{from:'a1', to:'a7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM19', chapter:'Mate in 1', title:'Queen Mate on d1', desc:'White to play and mate in one with the queen.',
      fen:'8/8/8/8/8/3K4/8/3k2Q1 w - - 0 1', side:'w',
      solution:[{from:'g1', to:'h1'}, {from:'g1', to:'f1'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM20', chapter:'Mate in 1', title:'Queen Mate on e8', desc:'White to play and mate in one with the queen.',
      fen:'4k3/4K3/8/7Q/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'h5', to:'e8'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'LM01', chapter:'Mate in 1', title:'Ladder Mate up the a-File', desc:'White to play and deliver mate with the second rook.',
    ...
    { id:'LM03', chapter:'Mate in 1', title:'Ladder Mate down the c-File', desc:'White to play and deliver mate with the second rook.',
