...
(function () {
  ...
  const LESSONS = [
    ...
    { id:'SK04', chapter:'Skewers & Discovered Attacks', title:'Discovered Attack Wins the Queen', desc:'White to play. Unveil your rook\'s check while the knight jumps to attack the queen.',
      ...
      solution:[{from:'e4', to:'f6'}], hint:'Move the knight to f6: the rook checks the king while the knight also hits the queen.', difficulty:4,
      reply:{from:'e8', to:'f8'},
    ...
    { id:'EG02', chapter:'Endgame Essentials', title:'Squeeze With King and Queen', desc:'White to play. Use the queen to shrink the enemy king\'s box one rank smaller.',
      ...
      solution:[{from:'d4', to:'c5'}], hint:'Play Qc5: a knight\'s-move from the king, it cuts the king\'s box without giving check or stalemate.', difficulty:3,
      concept:'To mate with king and queen, herd the lone king toward the edge by shrinking its box. Keep the queen exactly a knight\'s-move from the enemy king — close enough to confine it, far enough to never give check or stalemate.' },
