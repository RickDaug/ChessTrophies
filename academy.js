...
(function () {
  ...
  const LESSONS = [
    ...
    // MATE IN 1
    { id:'M01', chapter:'Mate in 1', title:'Back Rank #1', desc:'White to play and mate in one.',
    ...
    { id:'T03', chapter:'Tactics', title:'Skewer the King', desc:'White to play. Skewer the king to win the queen.',
      fen:'3k4/3q4/8/8/8/8/8/3R3K w - - 0 1', side:'w',
      solution:[{from:'d1', to:'d2'}], hint:'Force the king to move so you can take the queen behind.', difficulty:3 },
    { id:'T04', chapter:'Tactics', title:'Discovered Check', desc:'White to play. Move the knight to discover check and win the rook.',
      fen:'r3k3/8/8/8/3N4/8/8/3R2K1 w - - 0 1', side:'w',
      solution:[{from:'d4', to:'f5'}, {from:'d4', to:'b5'}, {from:'d4', to:'c6'}, {from:'d4', to:'e6'}, {from:'d4', to:'f3'}, {from:'d4', to:'b3'}, {from:'d4', to:'e2'}, {from:'d4', to:'c2'}], hint:'Any knight move discovers check.', difficulty:3 },
    ...
    { id:'BR01', chapter:'Mate in 1', title:'Back-Rank Mate #1', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR02', chapter:'Mate in 1', title:'Back-Rank Mate #2', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR03', chapter:'Mate in 1', title:'Back-Rank Mate #3', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR04', chapter:'Mate in 1', title:'Back-Rank Mate #4', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR05', chapter:'Mate in 1', title:'Back-Rank Mate #5', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR06', chapter:'Mate in 1', title:'Back-Rank Mate #6', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR07', chapter:'Mate in 1', title:'Back-Rank Mate #7', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR08', chapter:'Mate in 1', title:'Back-Rank Mate #8', desc:'White to play and mate in one with the rook.',
      fen:'5k2/4ppp1/8/8/8/8/7K/R7 w - - 0 1', side:'w',
      solution:[{from:'a1', to:'a8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR09', chapter:'Mate in 1', title:'Back-Rank Mate #9', desc:'White to play and mate in one with the rook.',
      fen:'5k2/4ppp1/8/8/8/8/7K/1R6 w - - 0 1', side:'w',
      solution:[{from:'b1', to:'b8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR10', chapter:'Mate in 1', title:'Back-Rank Mate #10', desc:'White to play and mate in one with the rook.',
      fen:'5k2/4ppp1/8/8/8/8/7K/2R5 w - - 0 1', side:'w',
      solution:[{from:'c1', to:'c8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR11', chapter:'Mate in 1', title:'Back-Rank Mate #11', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR12', chapter:'Mate in 1', title:'Back-Rank Mate #12', desc:'White to play and mate in one with the rook.',
      fen:'5k2/4ppp1/8/8/8/8/R6K/8 w - - 0 1', side:'w',
      solution:[{from:'a2', to:'a8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR13', chapter:'Mate in 1', title:'Back-Rank Mate #13', desc:'White to play and mate in one with the rook.',
      fen:'5k2/4ppp1/8/8/8/8/1R5K/8 w - - 0 1', side:'w',
      solution:[{from:'b2', to:'b8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR14', chapter:'Mate in 1', title:'Back-Rank Mate #14', desc:'White to play and mate in one with the rook.',
      fen:'5k2/4ppp1/8/8/8/8/2R4K/8 w - - 0 1', side:'w',
      solution:[{from:'c2', to:'c8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR15', chapter:'Mate in 1', title:'Back-Rank Mate #15', desc:'White to play and mate in one with the rook.',
      fen:'5k2/4ppp1/8/8/8/8/6KR/8 w - - 0 1', side:'w',
      solution:[{from:'h2', to:'h8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR16', chapter:'Mate in 1', title:'Back-Rank Mate #16', desc:'White to play and mate in one with the rook.',
      fen:'6k1/5ppp/8/8/8/8/7K/R7 w - - 0 1', side:'w',
      solution:[{from:'a1', to:'a8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR17', chapter:'Mate in 1', title:'Back-Rank Mate #17', desc:'White to play and mate in one with the rook.',
      fen:'6k1/5ppp/8/8/8/8/7K/1R6 w - - 0 1', side:'w',
      solution:[{from:'b1', to:'b8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR18', chapter:'Mate in 1', title:'Back-Rank Mate #18', desc:'White to play and mate in one with the rook.',
      fen:'6k1/5ppp/8/8/8/8/7K/2R5 w - - 0 1', side:'w',
      solution:[{from:'c1', to:'c8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR19', chapter:'Mate in 1', title:'Back-Rank Mate #19', desc:'White to play and mate in one with the rook.',
      fen:'6k1/5ppp/8/8/8/8/7K/3R4 w - - 0 1', side:'w',
      solution:[{from:'d1', to:'d8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR20', chapter:'Mate in 1', title:'Back-Rank Mate #20', desc:'White to play and mate in one with the rook.',
    ...
    { id:'BR21', chapter:'Mate in 1', title:'Back-Rank Mate #21', desc:'White to play and mate in one with the rook.',
      fen:'6k1/5ppp/8/8/8/8/R6K/8 w - - 0 1', side:'w',
      solution:[{from:'a2', to:'a8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR22', chapter:'Mate in 1', title:'Back-Rank Mate #22', desc:'White to play and mate in one with the rook.',
      fen:'6k1/5ppp/8/8/8/8/1R5K/8 w - - 0 1', side:'w',
      solution:[{from:'b2', to:'b8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR23', chapter:'Mate in 1', title:'Back-Rank Mate #23', desc:'White to play and mate in one with the rook.',
      fen:'6k1/5ppp/8/8/8/8/2R4K/8 w - - 0 1', side:'w',
      solution:[{from:'c2', to:'c8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR24', chapter:'Mate in 1', title:'Back-Rank Mate #24', desc:'White to play and mate in one with the rook.',
      fen:'7k/6pp/8/8/8/8/7K/R7 w - - 0 1', side:'w',
      solution:[{from:'a1', to:'a8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'BR25', chapter:'Mate in 1', title:'Back-Rank Mate #25', desc:'White to play and mate in one with the rook.',
      fen:'7k/6pp/8/8/8/8/7K/1R6 w - - 0 1', side:'w',
      solution:[{from:'b1', to:'b8'}], hint:'The king is stuck behind his own pawns — use the open rank.', difficulty:2 },
    { id:'QM01', chapter:'Mate in 1', title:'Queen Mate #1', desc:'White to play and mate in one with the queen.',
    ...
    { id:'QM02', chapter:'Mate in 1', title:'Queen Mate #2', desc:'White to play and mate in one with the queen.',
    ...
    { id:'QM03', chapter:'Mate in 1', title:'Queen Mate #3', desc:'White to play and mate in one with the queen.',
    ...
    { id:'QM04', chapter:'Mate in 1', title:'Queen Mate #4', desc:'White to play and mate in one with the queen.',
      fen:'2k5/1Q6/2K5/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'b7', to:'a8'}, {from:'b7', to:'c7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM05', chapter:'Mate in 1', title:'Queen Mate #5', desc:'White to play and mate in one with the queen.',
    ...
    { id:'QM06', chapter:'Mate in 1', title:'Queen Mate #6', desc:'White to play and mate in one with the queen.',
      fen:'2k5/1Q6/2K5/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'b7', to:'a8'}, {from:'b7', to:'c7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM07', chapter:'Mate in 1', title:'Queen Mate #7', desc:'White to play and mate in one with the queen.',
      fen:'3k4/2Q5/3K4/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'c7', to:'b8'}, {from:'c7', to:'d7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM08', chapter:'Mate in 1', title:'Queen Mate #8', desc:'White to play and mate in one with the queen.',
      fen:'2k5/1Q6/2K5/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'b7', to:'a8'}, {from:'b7', to:'c7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM09', chapter:'Mate in 1', title:'Queen Mate #9', desc:'White to play and mate in one with the queen.',
      fen:'5k2/4Q3/5K2/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'e7', to:'d8'}, {from:'e7', to:'f7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM10', chapter:'Mate in 1', title:'Queen Mate #10', desc:'White to play and mate in one with the queen.',
    ...
    { id:'QM11', chapter:'Mate in 1', title:'Queen Mate #11', desc:'White to play and mate in one with the queen.',
      fen:'2k5/1Q6/2K5/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'b7', to:'a8'}, {from:'b7', to:'c7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM12', chapter:'Mate in 1', title:'Queen Mate #12', desc:'White to play and mate in one with the queen.',
      fen:'5k2/6Q1/5K2/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'g7', to:'h8'}, {from:'g7', to:'f7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM13', chapter:'Mate in 1', title:'Queen Mate #13', desc:'White to play and mate in one with the queen.',
      fen:'4k3/3Q4/4K3/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'d7', to:'c8'}, {from:'d7', to:'e7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM14', chapter:'Mate in 1', title:'Queen Mate #14', desc:'White to play and mate in one with the queen.',
    ...
    { id:'QM15', chapter:'Mate in 1', title:'Queen Mate #15', desc:'White to play and mate in one with the queen.',
      fen:'2k5/1Q6/2K5/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'b7', to:'a8'}, {from:'b7', to:'c7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM16', chapter:'Mate in 1', title:'Queen Mate #16', desc:'White to play and mate in one with the queen.',
      fen:'5k2/4Q3/5K2/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'e7', to:'d8'}, {from:'e7', to:'f7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM17', chapter:'Mate in 1', title:'Queen Mate #17', desc:'White to play and mate in one with the queen.',
    ...
    { id:'QM18', chapter:'Mate in 1', title:'Queen Mate #18', desc:'White to play and mate in one with the queen.',
      fen:'4k3/3Q4/4K3/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'d7', to:'c8'}, {from:'d7', to:'e7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM19', chapter:'Mate in 1', title:'Queen Mate #19', desc:'White to play and mate in one with the queen.',
      fen:'5k2/4Q3/5K2/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'e7', to:'d8'}, {from:'e7', to:'f7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'QM20', chapter:'Mate in 1', title:'Queen Mate #20', desc:'White to play and mate in one with the queen.',
      fen:'5k2/4Q3/5K2/8/8/8/8/8 w - - 0 1', side:'w',
      solution:[{from:'e7', to:'d8'}, {from:'e7', to:'f7'}], hint:'King supports the queen as it delivers the final blow.', difficulty:2 },
    { id:'LM01', chapter:'Mate in 1', title:'Ladder Mate #1', desc:'White to play and deliver mate with the second rook.',
    ...
    { id:'LM02', chapter:'Mate in 1', title:'Ladder Mate #2', desc:'White to play and deliver mate with the second rook.',
      fen:'k7/2R5/8/8/8/8/8/K2R4 w - - 0 1', side:'w',
      solution:[{from:'d1', to:'d8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'LM03', chapter:'Mate in 1', title:'Ladder Mate #3', desc:'White to play and deliver mate with the second rook.',
      fen:'k7/3R4/8/8/8/8/8/K1R5 w - - 0 1', side:'w',
      solution:[{from:'c1', to:'c8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'LM04', chapter:'Mate in 1', title:'Ladder Mate #4', desc:'White to play and deliver mate with the second rook.',
      fen:'k7/4R3/8/8/8/8/8/K1R5 w - - 0 1', side:'w',
      solution:[{from:'c1', to:'c8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'LM05', chapter:'Mate in 1', title:'Ladder Mate #5', desc:'White to play and deliver mate with the second rook.',
      fen:'k7/5R2/8/8/8/8/8/K1R5 w - - 0 1', side:'w',
      solution:[{from:'c1', to:'c8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'LM06', chapter:'Mate in 1', title:'Ladder Mate #6', desc:'White to play and deliver mate with the second rook.',
      fen:'k7/6R1/8/8/8/8/8/K1R5 w - - 0 1', side:'w',
      solution:[{from:'c1', to:'c8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'LM07', chapter:'Mate in 1', title:'Ladder Mate #7', desc:'White to play and deliver mate with the second rook.',
      fen:'k7/7R/8/8/8/8/8/K1R5 w - - 0 1', side:'w',
      solution:[{from:'c1', to:'c8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'LM08', chapter:'Mate in 1', title:'Ladder Mate #8', desc:'White to play and deliver mate with the second rook.',
      fen:'1k6/3R4/8/8/8/8/8/K3R3 w - - 0 1', side:'w',
      solution:[{from:'e1', to:'e8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'LM09', chapter:'Mate in 1', title:'Ladder Mate #9', desc:'White to play and deliver mate with the second rook.',
      fen:'1k6/4R3/8/8/8/8/8/K2R4 w - - 0 1', side:'w',
      solution:[{from:'d1', to:'d8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'LM10', chapter:'Mate in 1', title:'Ladder Mate #10', desc:'White to play and deliver mate with the second rook.',
      fen:'1k6/5R2/8/8/8/8/8/K2R4 w - - 0 1', side:'w',
      solution:[{from:'d1', to:'d8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'LM11', chapter:'Mate in 1', title:'Ladder Mate #11', desc:'White to play and deliver mate with the second rook.',
      fen:'1k6/6R1/8/8/8/8/8/K2R4 w - - 0 1', side:'w',
      solution:[{from:'d1', to:'d8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'LM12', chapter:'Mate in 1', title:'Ladder Mate #12', desc:'White to play and deliver mate with the second rook.',
      fen:'1k6/7R/8/8/8/8/8/K2R4 w - - 0 1', side:'w',
      solution:[{from:'d1', to:'d8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'LM13', chapter:'Mate in 1', title:'Ladder Mate #13', desc:'White to play and deliver mate with the second rook.',
      fen:'2k5/R7/8/8/8/8/8/K3R3 w - - 0 1', side:'w',
      solution:[{from:'e1', to:'e8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'LM14', chapter:'Mate in 1', title:'Ladder Mate #14', desc:'White to play and deliver mate with the second rook.',
      fen:'2k5/4R3/8/8/8/8/8/K4R2 w - - 0 1', side:'w',
      solution:[{from:'f1', to:'f8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'LM15', chapter:'Mate in 1', title:'Ladder Mate #15', desc:'White to play and deliver mate with the second rook.',
      fen:'2k5/5R2/8/8/8/8/8/K3R3 w - - 0 1', side:'w',
      solution:[{from:'e1', to:'e8'}], hint:'One rook cuts off, the other delivers.', difficulty:3 },
    { id:'PIN01', chapter:'Tactics', title:'Pin the Queen #1', desc:'White to play. Take the queen — it\'s pinned to the king.',
      fen:'4k3/4q3/8/8/4R3/8/8/7K w - - 0 1', side:'w',
      solution:[{from:'e4', to:'e7'}], hint:'The queen can\'t move; the king is behind.', difficulty:2 },
    { id:'PIN02', chapter:'Tactics', title:'Pin the Queen #2', desc:'White to play. Take the queen — it\'s pinned to the king.',
      fen:'4k3/4q3/8/8/8/4R3/8/7K w - - 0 1', side:'w',
      solution:[{from:'e3', to:'e7'}], hint:'The queen can\'t move; the king is behind.', difficulty:2 },
    { id:'PIN03', chapter:'Tactics', title:'Pin the Queen #3', desc:'White to play. Take the queen — it\'s pinned to the king.',
      fen:'4k3/4q3/8/8/8/8/4R3/7K w - - 0 1', side:'w',
      solution:[{from:'e2', to:'e7'}], hint:'The queen can\'t move; the king is behind.', difficulty:2 },
    { id:'PIN04', chapter:'Tactics', title:'Pin the Queen #4', desc:'White to play. Take the queen — it\'s pinned to the king.',
      fen:'7K/8/8/4R3/8/8/4q3/4k3 w - - 0 1', side:'w',
      solution:[{from:'e5', to:'e2'}], hint:'The queen can\'t move; the king is behind.', difficulty:2 },
    { id:'PIN05', chapter:'Tactics', title:'Pin the Queen #5', desc:'White to play. Take the queen — it\'s pinned to the king.',
      fen:'7K/8/4R3/8/8/8/4q3/4k3 w - - 0 1', side:'w',
      solution:[{from:'e6', to:'e2'}], hint:'The queen can\'t move; the king is behind.', difficulty:2 },
    { id:'PIN06', chapter:'Tactics', title:'Pin the Queen #6', desc:'White to play. Take the queen — it\'s pinned to the king.',
      fen:'7K/4R3/8/8/8/8/4q3/4k3 w - - 0 1', side:'w',
      solution:[{from:'e7', to:'e2'}], hint:'The queen can\'t move; the king is behind.', difficulty:2 },
    { id:'PIN07', chapter:'Tactics', title:'Pin the Queen #7', desc:'White to play. Take the queen — it\'s pinned to the king.',
      fen:'3k4/3q4/8/8/3R4/8/8/7K w - - 0 1', side:'w',
      solution:[{from:'d4', to:'d7'}], hint:'The queen can\'t move; the king is behind.', difficulty:2 },
    { id:'PIN08', chapter:'Tactics', title:'Pin the Queen #8', desc:'White to play. Take the queen — it\'s pinned to the king.',
      fen:'3k4/3q4/8/8/8/3R4/8/7K w - - 0 1', side:'w',
      solution:[{from:'d3', to:'d7'}], hint:'The queen can\'t move; the king is behind.', difficulty:2 },
    { id:'PIN09', chapter:'Tactics', title:'Pin the Queen #9', desc:'White to play. Take the queen — it\'s pinned to the king.',
      fen:'3k4/3q4/8/8/8/8/3R4/7K w - - 0 1', side:'w',
      solution:[{from:'d2', to:'d7'}], hint:'The queen can\'t move; the king is behind.', difficulty:2 },
    { id:'PIN10', chapter:'Tactics', title:'Pin the Queen #10', desc:'White to play. Take the queen — it\'s pinned to the king.',
      fen:'7K/8/8/3R4/8/8/3q4/3k4 w - - 0 1', side:'w',
      solution:[{from:'d5', to:'d2'}], hint:'The queen can\'t move; the king is behind.', difficulty:2 },
    { id:'PIN11', chapter:'Tactics', title:'Pin the Queen #11', desc:'White to play. Take the queen — it\'s pinned to the king.',
      fen:'7K/8/3R4/8/8/8/3q4/3k4 w - - 0 1', side:'w',
      solution:[{from:'d6', to:'d2'}], hint:'The queen can\'t move; the king is behind.', difficulty:2 },
    { id:'PIN12', chapter:'Tactics', title:'Pin the Queen #12', desc:'White to play. Take the queen — it\'s pinned to the king.',
      fen:'7K/3R4/8/8/8/8/3q4/3k4 w - - 0 1', side:'w',
      solution:[{from:'d7', to:'d2'}], hint:'The queen can\'t move; the king is behind.', difficulty:2 },
    { id:'PR01', chapter:'Foundations', title:'Promotion Push #1', desc:'White to play. Promote the pawn on A-file to a queen.',
    ...
    { id:'PR02', chapter:'Foundations', title:'Promotion Push #2', desc:'White to play. Promote the pawn on B-file to a queen.',
    ...
    { id:'PR03', chapter:'Foundations', title:'Promotion Push #3', desc:'White to play. Promote the pawn on C-file to a queen.',
    ...
    { id:'PR04', chapter:'Foundations', title:'Promotion Push #4', desc:'White to play. Promote the pawn on D-file to a queen.',
    ...
    { id:'PR05', chapter:'Foundations', title:'Promotion Push #5', desc:'White to play. Promote the pawn on E-file to a queen.',
    ...
    { id:'PR06', chapter:'Foundations', title:'Promotion Push #6', desc:'White to play. Promote the pawn on F-file to a queen.',
    ...
    { id:'PR07', chapter:'Foundations', title:'Promotion Push #7', desc:'White to play. Promote the pawn on G-file to a queen.',
    ...
    { id:'PR08', chapter:'Foundations', title:'Promotion Push #8', desc:'White to play. Promote the pawn on H-file to a queen.',
